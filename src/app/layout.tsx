...
export const metadata = {
  metadataBase: new URL('https://ecokhemia.com'),
  title: 'Ecokhemia',
  description:
    'Somos una empresa de limpieza industrial que utiliza diversas tecnologías para ofrecer soluciones eficientes, seguras y responsables con el medio ambiente.',
  openGraph: {
    title: 'Ecokhemia',
    description:
      'Somos una empresa de limpieza industrial que utiliza diversas tecnologías para ofrecer soluciones eficientes, seguras y responsables con el medio ambiente.',
